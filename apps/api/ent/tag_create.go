...
func (_c *TagCreate) SetUserID(v string) *TagCreate {
...
func (_c *TagCreate) check() error {
	...
	if v, ok := _c.mutation.UserID(); ok {
		if err := tag.UserIDValidator(v); err != nil {
			return &ValidationError{Name: "user_id", err: fmt.Errorf(`ent: validator failed for field "Tag.user_id": %w`, err)}
		}
	}
...
func (_c *TagCreate) createSpec() (*Tag, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UserID(); ok {
		_spec.SetField(tag.FieldUserID, field.TypeString, value)
		_node.UserID = value
	}
